...
namespace Net {
	...
	public:
		...
		enum Opcodes { kExtInfo = 0x10, kExtEntry = 0x11, kCustomBlocks = 0x13, kSetTextHotkey = 0x15, kExtAddPlayerName = 0x16, kExtAddEntity2 = 0x21, kChangeModel = 0x1D, kDefineBlock = 0x23, kPlayerClick = 0x22, kHoldThis = 0x14 };
		...
		public:
			uint8_t blockToHold, preventChange;
